...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permission_groups'], function (Blueprint $table) use ($tableNames) {
            $table->bigIncrements('id');
            $table->string('name');
            $table->unsignedBigInteger('user_id')->nullable()->comment('Unique Id of Created User');
            $table->timestamps();
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) use ($tableNames) {
            ...
            $table->foreign('group_id')
                ->references('id')
                ->on($tableNames['permission_groups'])
                ->onDelete('cascade');
        });
