...
<div class="card">
    <div class="card-datatable table-responsive pt-0">
        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons">
                        <a id="createNewRole" class="dt-button create-new btn btn-primary"
                            data-endpoint="{{ route('announcements.create') }}" data-target="modal-default"
                            data-cache="false" data-toggle='modal' href='#' data-async="true">
                            <span>
                                <i class="mdi mdi-plus me-sm-1"></i>
                                <span class="d-none d-sm-inline-block">Add Announcement</span>
                            </span>
                        </a>
                    </div>
                </div>
            ...
            <div id="showresult">
                @include('announcements.listPagin')
            </div>
        </div>
    </div>
</div>
