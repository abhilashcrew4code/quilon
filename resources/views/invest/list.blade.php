        ...
        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
            <div class="card-header flex-column flex-md-row">
                <div class="head-label text-center">
                    <h4 class="card-header">Invest</h4>
                </div>
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons">

                        <a id="createNewRole" class="dt-button create-new btn btn-primary"
                            data-endpoint="{{ route('invest.create') }}" data-target="modal-default" data-cache="false"
                            data-toggle='modal' href='#' data-async="true">
                            <span>
                                <i class="mdi mdi-plus me-sm-1"></i>
                                <span class="d-none d-sm-inline-block">Add Invest</span>
                            </span>
                        </a>
                    </div>
                </div>
...
<script type="text/javascript">
    $(window).on('hashchange', function() {
        ...
        function getData(page){
            ...
            $.ajax(
            {
                url: '?page=' + page + '&entry_count='+ entry_count + '&order_status='+ order_status + '&search='+ search,
                type: "get",
                datatype: "html"
            }).done(function(data){
