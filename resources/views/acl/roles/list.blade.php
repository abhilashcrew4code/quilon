...
<div class="card-body">
    <div class="alert alert-@if(session('success_message'))success @elseif(session('error_message'))danger @endif alert-dismissible"
        ...
        <h4 class="alert-heading d-flex align-items-center">
            <i class="mdi mdi-check-circle-outline mdi-24px me-2"></i>{{ session('success_message') }}
        </h4>
        <hr />
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        @elseif(session('error_message'))
        <h4 class="alert-heading d-flex align-items-center">
            <i class="mdi mdi-alert-circle-outline mdi-24px me-2"></i> Alert!
        </h4>
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons">
                        ...
                        <a id="createNewRole" class="dt-button create-new btn btn-primary"
                            data-endpoint="{{ route('roles.create') }}" data-target="modal-default" data-cache="false"
