    ...
    <div class="exception-summary">
        <div class="container">
            <div class="exception-message-wrapper">
                <h1 class="break-long-words exception-message">{{ $exceptionMessage }}</h1>
                ...
                <thead class="trace-head">
                    <tr>
                        <th>
                            ...
                            <p class="break-long-words trace-message">{{ $exceptionMessage }}</p>
                            <br>
                            <p class="">URL: {{ $url}}</p>
                            <p class="">IP: {{ $ip }}</p>
                            <p class="">Date Time: {{ $time }}</p>
                            <p class="">File: {{ $exceptionFile }}</p>
                            <p class="">Line: {{ $exceptionLine }}</p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <span class="block trace-file-path">in <span title="{{ $exceptionFile }}"><strong>{{ $exceptionFile }}</strong> line {{ $exceptionLine }}</span></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
